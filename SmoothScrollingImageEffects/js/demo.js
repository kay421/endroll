        ...
        constructor(el) {
            ...
            this.renderedStyles = {
                ...
                titleTranslationY: {
                    ...
                    current: 0,
                    ease: 0.1,
                    fromValue: 60,//Number(MathUtils.getRandomFloat(30,400)),
                    setValue: () => {
                    ...
                    if( this.response )
                    {
                        ...
                        for (const item of (this.response.items).reverse()) {
                            ...
                            <div class="content__item content__item--wide">
                            	...
                            	<div class="content__item-imgwrap"><div class="content__item-img" style="background-image: url(https://picsum.photos/600/400?salt=${idx});"></div></div>
